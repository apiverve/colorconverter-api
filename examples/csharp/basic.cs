...
{
    class ColorConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/colorconverter";

        /// <summary>
        /// Make a GET request to the Color Converter API
        /// </summary>
        static async Task<JsonDocument> CallColorConverterAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;hex&quot;] &#x3D; &quot;FF0000&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Color Converter API...\n");

            var result = await CallColorConverterAPI();
