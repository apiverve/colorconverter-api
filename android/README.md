...
```gradle
dependencies {
    implementation 'com.github.apiverve:colorconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.colorconverter.ColorConverterAPIClient;
import com.apiverve.colorconverter.APIResponse;
import com.apiverve.colorconverter.APIException;

// Initialize the client
ColorConverterAPIClient client = new ColorConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("hex", "FF0000");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/colorconverter](https://docs.apiverve.com/ref/colorconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/colorconverter](https://docs.apiverve.com/ref/colorconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/colorconverter-api/issues)
