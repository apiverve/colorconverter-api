...
//
//     ColorConverterData data = Converter.fromJsonString(jsonString);

package com.apiverve.colorconverter.data;
...
public class Converter {
    ...
    public static ColorConverterData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(ColorConverterData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(ColorConverterData.class);
        writer = mapper.writerFor(ColorConverterData.class);
    }
