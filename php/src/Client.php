...
namespace APIVerve\Colorconverter;
...
/**
 * Client for the Color Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/colorconverter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/colorconverter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ColorconverterClient] {$message}\n";
        }
    }
}
