// Package colorconverter provides a Go client for the Color Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/colorconverter?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/colorconverter"
	defaultTimeout = 30 * time.Second
)

// Client is the Color Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Color Converter API client.
...
// Execute makes a request to the Color Converter API with typed parameters.
//
...
//   - hex (required): string - The color in hexadecimal format (e.g., FF0000). Make sure you ommit the #
